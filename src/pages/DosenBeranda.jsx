        ...
        <div className="row">
          ...
          <div className="col p-5 margin-custom-tp3">
            ...
            <button className="btn btn-md btn-warning rounded-pill  btn-custom-wd mx-custom " type="button">
              <a className="text-white text-decoration-none" href="login.jsx">
                {' '}
                Mulai{' '}
              </a>{' '}
            </button>
        ...
        <div className="container">
          <div className="row">
            <div class="col-md-5 col-sm-12">
              ...
              <p className="margin-custom-lf2"> Eduvion hadir sebagai sarana bagi para mahasiswa dan juga dosen pembimbing untuk mengelola, dan melakukan bimbingan. Semuanya secara online!</p>
            </div>
            ...
            <div className="col-md-4 col-sm-6 m-cust-tp4 margin-custom-lf3 ">
              <div class="card rounded-cust card-size shadow-cust">
                <div class="card-body bg-primary rounded-cust card-size p-5 shadow-cust">
                  ...
                  <p class="card-text text-white">Kumpulan Artikel dan Jurnal yang dapat diakses secara online dalam format PDF oleh pengguna</p>
                  <Link to="/Jurnaldosen">
                    <a href="#" class="btn btn-warning rounded-pill  btn-custom-wd text-white ">
                      Selengkapnya
                    </a>
