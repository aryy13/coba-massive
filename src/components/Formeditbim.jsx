      ...
      <div>
        <form onSubmit={handleSubmit}>
          <div className="row mb-3">
            <label className="col-sm-2 col-form-label">Npm: </label>
            <div className="col-sm-10">
              <input className="input-custom" type="text" name="Npm" value={inputNpm} onChange={handleChangeInputNpm} />
            </div>
            <br />
          </div>
          ...
          <div className="row mb-3">
            ...
            <div className="col-sm-10">
              <input className="input-custom" type="Date" name="Tgl" value={inputTgl} onChange={handleChangeInputTgl} />
            </div>
            <br />
          </div>
          ...
          <div className="row mb-3">
            ...
            <div className="col-sm-10">
              <input className="input-custom" type="text" name="Judul" value={inputJudul} onChange={handleChangeInputJudul} />
            </div>
            <br />
          </div>
          ...
          <div className="row mb-3">
            <label className="col-sm-2 col-form-label">Tahapan: </label>
            <div className="col-sm-10">
              <input className="input-custom" type="text" name="Tahapan" value={inputTahapan} onChange={handleChangeInputTahapan} />
            </div>
            <br />
          </div>
          ...
          <div className="row mb-3">
            ...
            <div className="col-sm-10">
              <input className="input-custom" type="text" name="Tahapan" value={inputLink} onChange={handleChangeInputLink} />
            </div>
            <br />
          </div>

          <div className="row mb-3">
            <label className="col-sm-2 col-form-label">Status Skripsi: </label>
